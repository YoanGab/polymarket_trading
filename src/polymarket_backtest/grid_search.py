...
def expanded_strategy_grid() -> list[StrategyConfig]:
    ...
    return [
        StrategyConfig(
            name="carry_conservative",
            family="carry_only",
            kelly_fraction=0.03,
            edge_threshold_bps=15.0,
        ...
        StrategyConfig(
            name="news_conservative",
            family="news_driven",
            kelly_fraction=0.08,
            edge_threshold_bps=75.0,
            max_position_notional=400.0,
        ...
        # These avoid spread churn from frequent entry/exit
        StrategyConfig(
            name="edge_hold_tight",
            family="edge_based",
            kelly_fraction=0.03,
            edge_threshold_bps=75.0,
            max_position_notional=200.0,
        ...
        # Contrarian hold: no time stop, let position resolve or thesis exit
        StrategyConfig(
            name="contrarian_hold",
            family="contrarian",
            kelly_fraction=0.05,
            edge_threshold_bps=30.0,
            max_position_notional=200.0,
        ...
        # No thesis stop: pure hold-to-resolution, ignoring model prediction changes
        # thesis_stop_delta repurposed as exit buffer: exit when mid > extreme_low + delta
        StrategyConfig(
            name="contrarian_hold_nothesis",
            family="contrarian",
            kelly_fraction=0.15,
            edge_threshold_bps=30.0,
            max_position_notional=600.0,
            ...
            thesis_stop_delta=0.08,  # exit at mid > 0.18
        ),
        StrategyConfig(
            name="contrarian_nothesis_buf15",
            family="contrarian",
            kelly_fraction=0.15,
            edge_threshold_bps=30.0,
            max_position_notional=600.0,
            ...
            extreme_low=0.10,
            use_thesis_stop=False,
            thesis_stop_delta=0.15,  # exit at mid > 0.25
        ),
        StrategyConfig(
            name="contrarian_nothesis_buf20",
            family="contrarian",
            kelly_fraction=0.15,
            edge_threshold_bps=30.0,
            max_position_notional=600.0,
            ...
            extreme_low=0.10,
            use_thesis_stop=False,
            thesis_stop_delta=0.20,  # exit at mid > 0.30
        ),
    ]
